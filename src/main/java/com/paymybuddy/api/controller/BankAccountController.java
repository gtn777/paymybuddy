...
public class BankAccountController extends ControllerClass {
    ...
    public Object getAddBankAccountPage(Authentication auth) {
    ...
    public Object deleteBankAccount(Authentication auth) {
    ...
    public Object sendMoneyToBank(Authentication auth,
	@ModelAttribute(value = "amount") int amount) {
